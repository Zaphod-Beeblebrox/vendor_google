...
ifneq ($(filter libjni_mosaic libjni_tinyplanet libjpeg libnativehelper_compat, $(PRODUCT_GOOGLE_PREBUILT_MODULES)), )
...
# GalleryGoogle
include $(CLEAR_VARS)
ifneq ($(filter libjni_eglfence libjni_filtershow_filters librsjni, $(PRODUCT_GOOGLE_PREBUILT_MODULES)), )
